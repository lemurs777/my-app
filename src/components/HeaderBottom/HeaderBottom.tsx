      ...
      <div className={styles.content}>
        ...
        <ul className={styles.list}>
          <li className={styles.item}>
            <Link className={clsx(styles.link, styles.linkCustom)} to="/">LIVE события</Link>
          </li>
          <li className={styles.item}>
            <Link className={styles.link} to="/">3ч</Link>
          </li>
          <li className={styles.item}>
            <Link className={styles.link} to="/">6ч</Link>
          </li>
          <li className={styles.item}>
            <Link className={styles.link} to="/">12ч</Link>
          </li>
          <li className={styles.item}>
            <Link className={clsx(styles.link, styles.linkActive)} to="/">Сегодня</Link>
          </li>
          <li className={styles.item}>
            <Link className={styles.link} to="/">Завтра</Link>
          </li>
          <li className={styles.item}>
            <Link className={styles.link} to="/">Суббота</Link>
          </li>
          <li className={styles.item}>
            <Link className={styles.link} to="/">Воскресенье</Link>
          </li>
        </ul>
