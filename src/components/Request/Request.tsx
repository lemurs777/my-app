    ...
    <div className={styles.request}>
      <div className={styles.wrapper}>
        <div className={styles.header}>
          <Link className={clsx(styles.topBtn, 'mobile')} to='/requests'>Requests</Link>
        ...
        <div className={styles.infoRequest}>
          <div className={styles.top}>
            ...
            <button className={clsx(styles.close, 'mobile')}><CloseIcon/></button>
          </div>
          {arrRequestsFilter.map((item, index) => (
            <div key={index} className={styles.content}>
              <div key={index} className={styles.contentTop}>
                ...
                <p className={clsx(styles.contentText, styles.contentTextTitle)}>Приклепленные фото:</p>
                ...
                <p className={clsx(styles.contentText, styles.contentTextTitle)}>История разговора:</p>
              </div>
