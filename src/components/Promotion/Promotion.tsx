...
function Promotion() {
    ...
    return (
        <div className={styles.promotion}>
            <div className={styles.promotion__banner}>
				<div className={styles.promotion__link}>
                    <BackLink/>
                </div>
                ...
                <div className={styles.info}>
                    <div className={styles.top}>
                        ...
                        <div className={styles.topContent}>
                            ...
                            <p className={styles.topText}>В период с 05.04.2021 по 27.04.2021 делайте ставки на любую из
                                игр категории <Link className="promotion__info-top-link"
                                                    to="/promotions/">киберспорт</Link> и станьте победителем розыгрыша
                                9999₽.</p>
                            <p className={styles.topText}>Чем больше Вы ставите, тем больше ваши шансы выиграть главный
                                приз!</p>
                        </div>
                    </div>
                    <div className={styles.about}>
                        ...
                        <ul className={styles.aboutList}>
                            <li className={styles.aboutItem}>
                                <img className={styles.aboutItemImg} src={PromoListImg1} alt="Step 1" width="90"
                                     height="90"/>
                                <div className={styles.aboutItemText}>Регистрируйся и <span
                                    className={styles.aboutItemTextAccent}>получай бонусы</span></div>
                            </li>
                            <li className={styles.aboutItem}>
                                <img className={styles.aboutItemImg} src={PromoListImg2} alt="Step 2" width="90"
                                     height="90"/>
                                <div className={styles.aboutItemText}>Ставь на киберспорт и <span
                                    className={styles.aboutItemTextAccent}>получай очки</span></div>
                            </li>
                            <li className={styles.aboutItem}>
                                <img className={styles.aboutItemImg} src={PromoListImg3} alt="Step 3" width="90"
                                     height="90"/>
                                <div className={styles.aboutItemText}>Выиграй и <br/><span
                                    className={styles.aboutItemTextAccent}>получай награды</span></div>
                            </li>
                        </ul>
                    </div>
                        ...
                        {arrTask.map((item, index) => (
                            ...
                            >
                                ...
                                <div className={clsx(
                                    ...
                                    <span className={styles.tasksItemInfoNum}>{item.done}</span>&nbsp;/&nbsp;<span
                                    className={styles.tasksItemInfoNum}>{item.all}</span>
                                </div>
                            </li>
                        ))}
                    </ul>
