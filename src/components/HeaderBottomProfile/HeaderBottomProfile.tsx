...
import styles from './HeaderBottomProfile.module.scss';

function HeaderBottomProfile() {
return (
	<div className={styles.headerBottomProfile}>
		<div className={styles.content}>
			<label className={styles.searchLabel}>
				<input className={styles.search} type="text" placeholder="Поиск по профилю"/>
...
export default HeaderBottomProfile;