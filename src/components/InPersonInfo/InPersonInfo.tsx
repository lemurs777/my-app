				...
				<div className={styles.content}>
					...
					<div className={styles.colOne}>
						...
						<div className={styles.colOneMiniTable}>
							<div className={styles.colOneMiniTableNum} style={{bottom: `${data.tablePercentOne * 100}%`}}>#{data.tablePositionOne}</div>
						</div>
					...
					<div className={clsx(styles.colOne, styles.colOneRight)}>
						...
						<div className={clsx(styles.colOneMiniTable, styles.colOneMiniTableRight)}>
							<div className={clsx(styles.colOneMiniTableNum, styles.colOneMiniTableNumRight)} style={{bottom: `${data.tablePercentTwo * 100}%`}}>#{data.tablePositionTwo}</div>
						</div>
